	...
	<div class="commentlist-item">
		<div <?php comment_class(); ?> id="comment-<?php comment_ID(); ?>">
			...
			<div class="commentlist-holder">
				...
				<p class="meta"><a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>"><?php comment_date('F d, Y'); ?> <?php _e('at', 'base'); ?> <?php comment_time('g:i a'); ?></a>, <?php comment_author_link(); ?> <?php _e('said:', 'base'); ?></p>
